...
<head>
    ...
    <title>@yield('title', 'OrderService - Transaksi')</title>
...
<body>
    <nav class="navbar">
        <div class="navbar-inner">
            ...
            <div class="navbar-links">
                <a href="{{ route('orders.index') }}" class="{{ request()->routeIs('orders.index') ? 'active' : '' }}">📊 Dashboard</a>
                <a href="{{ route('orders.create') }}" class="{{ request()->routeIs('orders.create') ? 'active' : '' }}">➕ Buat Pesanan</a>
    ...
    <footer class="footer">
        ...
        <div class="service-info">🔗 OrderService (Provider & Consumer) · REST API · Laravel</div>
    </footer>
    @yield('scripts')
</body>
</html>
