...
@section('title', 'Buat Pesanan - OrderService')
        ...
        <div class="form-card">
            ...
            <form method="POST" action="{{ route('orders.store') }}">
                ...
                <div class="form-group">
                    ...
                    @error('motor_id') <span style="color:#fca5a5;font-size:0.8rem">{{ $message }}</span> @enderror
                </div>
                ...
                <div class="form-grid">
                    <div class="form-group">
                        ...
                        @error('nama_pelanggan') <span style="color:#fca5a5;font-size:0.8rem">{{ $message }}</span> @enderror
                    </div>
                    <div class="form-group">
                        <label for="no_telepon">📱 No. Telepon</label>
                        <input type="text" name="no_telepon" id="no_telepon" class="form-control"
                               value="{{ old('no_telepon') }}" placeholder="08xxxxxxxxxx" required>
                        @error('no_telepon') <span style="color:#fca5a5;font-size:0.8rem">{{ $message }}</span> @enderror
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    @error('alamat') <span style="color:#fca5a5;font-size:0.8rem">{{ $message }}</span> @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    @error('jumlah') <span style="color:#fca5a5;font-size:0.8rem">{{ $message }}</span> @enderror
                </div>
